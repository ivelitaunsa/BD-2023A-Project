...
public class R1Z_CHARLA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaCharla = new javax.swing.JTable();
        ...
        jLabel2.setText("Registro de Charla");
        ...
        tablaCharla.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaCharla.setShowHorizontalLines(true);
        jScrollPane1.setViewportView(tablaCharla);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if(CarFlaAct == 1) {
            ...
            try {
                ...
                switch(comandoActivo) {      
                    case 1 -> { 
                        stmt = conn.prepareStatement("INSERT INTO R1Z_CHARLA (ChaNum, ChaTem, EstRegCod) VALUES (?, ?, ?)");
                        stmt.setString(1, codigo);
                        stmt.setString(2, descripcion);
                        stmt.setString(3, estadoRegistro);
                    }
                    case 2 -> { 
                        stmt = conn.prepareStatement("UPDATE R1Z_CHARLA SET ChaTem = ? WHERE ChaNum = ?");
                        stmt.setString(1, descripcion);
                        stmt.setString(2, codigo);
                    }
                    default -> {
                        stmt = conn.prepareStatement("UPDATE R1Z_CHARLA SET EstRegCod = ? WHERE ChaNum = ?");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        int filaSeleccionada = tablaCharla.getSelectedRow();
    ...
    private void llenarTablaCargo() {        
        modelo.setColumnIdentifiers(new Object[]{"Numero", "Tema", "Estado Registro"});
        ...
        try {
            ...
            //Agregando los datos
            while(rs.next()) {
                modelo.addRow(new Object[]{rs.getString("ChaNum"), rs.getString("ChaTem"), rs.getString("EstRegCod")});
            }
            //Asigna Modelo a tabla
            tablaCharla.setModel(modelo);
    ...
    private javax.swing.JTable tablaCharla;
