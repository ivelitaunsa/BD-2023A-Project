...
public class GZZ_ESTADO_REGISTRO extends javax.swing.JFrame {
    ...
    public GZZ_ESTADO_REGISTRO() {
        getRootPane().setWindowDecorationStyle(JRootPane.PLAIN_DIALOG);
        initComponents();
        llenarTablaEstadoRegistro();
    }
    ...
    private void initComponents() {
        ...
        tablaEstadoRegistro = new javax.swing.JTable();
        ...
        setTitle("Tabla Estado de Registro");
        setUndecorated(true);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("Estadod de Registro");
        ...
        jLabel2.setText("Registro de Estado de Registro");
        ...
        tablaEstadoRegistro.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaEstadoRegistro.setShowHorizontalLines(true);
        jScrollPane1.setViewportView(tablaEstadoRegistro);
        ...
        jLabel6.setText("Tabla_Estado_Registro");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if(CarFlaAct == 1) {
            ...
            try {
                ...
                switch(comandoActivo) {      
                    case 1 -> { 
                        stmt = conn.prepareStatement("INSERT INTO GZZ_ESTADO_REGISTRO (EstRegCod, EstRegDes, EstRegEstReg) VALUES (?, ?, ?)");
                        stmt.setString(1, codigo);
                        stmt.setString(2, descripcion);
                        stmt.setString(3, estadoRegistro);
                    }
                    case 2 -> { 
                        stmt = conn.prepareStatement("UPDATE GZZ_ESTADO_REGISTRO SET EstRegDes = ? WHERE EstRegCod = ?");
                        stmt.setString(1, descripcion);
                        stmt.setString(2, codigo);
                    }
                    default -> {
                        stmt = conn.prepareStatement("UPDATE GZZ_ESTADO_REGISTRO SET EstRegEstReg = ? WHERE EstRegCod = ?");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        int filaSeleccionada = tablaEstadoRegistro.getSelectedRow();
    ...
    private void llenarTablaEstadoRegistro() {        
        modelo.setColumnIdentifiers(new Object[]{"Codigo", "Descripcion", "Estado Registro"});
        modelo.setRowCount(0);
        try {
            //Consulta de selección
            Statement statement = conn.createStatement();
            String consulta = "SELECT EstRegCod, EstRegDes, EstRegEstReg  FROM GZZ_ESTADO_REGISTRO WHERE EstRegCod NOT IN ('*')";
            ResultSet rs = statement.executeQuery(consulta);
            
            //Agregando los datos
            while(rs.next()) {
                modelo.addRow(new Object[]{rs.getString("EstRegCod"), rs.getString("EstRegDes"), rs.getString("EstRegEstReg")});
            }
            //Asigna Modelo a tabla
            tablaEstadoRegistro.setModel(modelo);
    ...
    private javax.swing.JTable tablaEstadoRegistro;
